...
UNITY_INSTANCING_BUFFER_START(PerCube)
    UNITY_DEFINE_INSTANCED_PROP(half4, _BaseColor)
UNITY_INSTANCING_BUFFER_END(PerCube)
...
inline void InitializeStandardLitSurfaceData(float2 uv, out SurfaceData outSurfaceData)
{
    ...
    outSurfaceData.alpha = Alpha(albedoAlpha.a, UNITY_ACCESS_INSTANCED_PROP(PerCube, _BaseColor), _Cutoff);

    half4 specGloss = SampleMetallicSpecGloss(uv, albedoAlpha.a);
    outSurfaceData.albedo = albedoAlpha.rgb * UNITY_ACCESS_INSTANCED_PROP(PerCube, _BaseColor).rgb;
